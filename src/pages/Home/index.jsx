  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80)",
        }}
      >
        <div className="hero-overlay bg-[#007CBD] bg-opacity-70"></div>
        <div className="hero-content text-center text-white">
          <div>
            ...
            <button
              className="btn bg-[#3EB7DD] hover:bg-[#3EB7DD] border-none mt-3"
