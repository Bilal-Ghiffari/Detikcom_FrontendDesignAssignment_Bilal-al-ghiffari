  ...
  return (
    <div className="h-72 bg-gradient-to-b from-cyan-500 to-blue-500 relative">
      <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2">
        ...
        <div className="bg-white w-[550px] h-full py-5 rounded-xl">
          <form className="flex flex-col gap-4 px-24 md:px-5">
            <div className="">
              <TextInput
            ...
            <div>
              <TextInput placeholder="Email" required shadow type="email" />
            </div>
            <div>
              <TextInput
            ...
            <div className="flex gap-5">
              <div className="w-52 h-32 bg-gray-200 flex justify-center items-center">
                <label
                  htmlFor="files"
                ...
                <TextInput required type="file" id="files" className="hidden" />
              </div>
              <div>
            ...
            <div>
              ...
              />
              <span className="text-sm text-gray-400">
                Website, Sosial media, dll Sertakan protokol URL
              </span>
            </div>
